...
import com.sdxxtop.guardianapp.presenter.ProblemGJDetailPresenter;
...
public class ProblemGJDetailActivity extends BaseMvpActivity<ProblemGJDetailPresenter> implements ProblemGJDetailContract.IView,
    ...
    /***问题攻坚***/
    @BindView(R.id.tvWentiTx)
    TextView tvWentiTx;
    @BindView(R.id.tvCuoshiTx)
    TextView tvCuoshiTx;
    @BindView(R.id.tvShixiaoTx)
    TextView tvShixiaoTx;
    @BindView(R.id.tvZerenTx)
    TextView tvZerenTx;
    @BindView(R.id.wentiDesc)
    TextView wentiDesc;
    @BindView(R.id.cuoshiDesc)
    TextView cuoshiDesc;
    @BindView(R.id.shixiaoDesc)
    TextView shixiaoDesc;
    @BindView(R.id.zerenDesc)
    TextView zerenDesc;
    ...
    protected void initView() {
        super.initView();
        /**问题攻坚***/
        wentiDesc.setVisibility(View.VISIBLE);
        cuoshiDesc.setVisibility(View.VISIBLE);
        shixiaoDesc.setVisibility(View.VISIBLE);
        zerenDesc.setVisibility(View.VISIBLE);
        tvWentiTx.setVisibility(View.VISIBLE);
        tvCuoshiTx.setVisibility(View.VISIBLE);
        tvShixiaoTx.setVisibility(View.VISIBLE);
        tvZerenTx.setVisibility(View.VISIBLE);
        ...
        tvTitle.getTvRight().setText("");
        tvTitle.getTvRight().setOnClickListener(v -> {
//            Intent intent = new Intent(ProblemGJDetailActivity.this, RecordLogActivity.class);
//            intent.putExtra("eventId", mEventId);
//            startActivity(intent);
        });

        dialog = new BottomStyleDialog(ProblemGJDetailActivity.this, mEventId, popwindow_bg);
...
//        isFinish = bean.is_finish;
    ...
    private void collectHeadData(EventStreamDetailBean bean) {
        ...
        /***问题攻坚数据***/
        tvWentiTx.setText(bean.problem);
        tvCuoshiTx.setText(bean.measures);
        tvShixiaoTx.setText(bean.prescription);
        tvZerenTx.setText(bean.responsibility);
    ...
    public static void startDetailActivity(Context context, String eventId) {
        Intent intent = new Intent(context, ProblemGJDetailActivity.class);
...
//
                ...
                if (eventStatus == 2) {
                    ...
                    Intent intent = new Intent(ProblemGJDetailActivity.this, EventMoveActivity.class);
                    intent.putExtra("eventId", mEventId);
