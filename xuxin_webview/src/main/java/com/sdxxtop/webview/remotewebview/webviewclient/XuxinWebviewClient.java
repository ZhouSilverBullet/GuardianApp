package com.sdxxtop.webview.remotewebview.webviewclient;
...
import static com.sdxxtop.webview.remotewebview.BaseWebView.CONTENT_SCHEME;

public class XuxinWebviewClient extends WebViewClient {
    ...
    public XuxinWebviewClient(WebView webView, WebViewCallBack webViewCallBack, Map<String, String> headers, WebviewTouch touch){
